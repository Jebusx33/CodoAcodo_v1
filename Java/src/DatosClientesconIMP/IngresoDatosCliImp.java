...
public class IngresoDatosCliImp extends javax.swing.JFrame {
   ...
   // ArrayList<Clientes>lista =new ArrayList<Clientes>();
    ...
    public IngresoDatosCliImp() {
      ...
      TablaImpresion z=new TablaImpresion();
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresoDatosCliImp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IngresoDatosCliImp().setVisible(true);
            }
        });
    }
